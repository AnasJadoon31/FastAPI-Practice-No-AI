...
from app.api.schemas.schemas import TeacherGet
from app.api.schemas.schemas import TeacherUpdate
from fastapi import HTTPException
from app.database.models import ModelTeacherUpdate
from app.api.schemas.schemas import TeacherDelete
...
@router.get("/{teacher_id}", response_model=TeacherGet)
...
@router.delete("/{teacher_id}", response_model=TeacherDelete)
